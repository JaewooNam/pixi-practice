...
//add sprite itself
var containerSprite = new PIXI.projection.Sprite2s(new PIXI.Texture.fromImage('images/dungeon.jpg'));
...
var bunny = new PIXI.projection.Sprite2s(new PIXI.Texture.fromImage('images/frame.png'));
